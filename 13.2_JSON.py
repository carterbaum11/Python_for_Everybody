...
counts from the JSON data, compute the sum of the numbers in the file and
enter the sum below:
...
Actual data: http://py4e-data.dr-chuck.net/comments_1563091.json (Sum ends with 2)
...
if len(address) < 1:
    address = "http://py4e-data.dr-chuck.net/comments_1563091.json"
