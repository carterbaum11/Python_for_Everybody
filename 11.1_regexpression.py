...
Sample data: http://py4e-data.dr-chuck.net/regex_sum_42.txt (There are 90 values
with a sum=445833)
Actual data: http://py4e-data.dr-chuck.net/regex_sum_1563086.txt
(There are 76 values and the sum ends with 816)
...
hand = open('regex_sum_1563086.txt')
sum = 0
